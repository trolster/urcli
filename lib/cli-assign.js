...
// The interval (in tickrates) for when to request information:
const feedbacksInterval = 5 // 5 minutes
const positionInterval = 5 // 5 minutes
const refreshInterval = 55 // 55 minutes
